...
const Header = () => {
  ...
  }, [searchQuery, navigate, showMobileMenu]);
  ...
  const renderNavLinks = useCallback(() => {
    ...
    const governmentLinks = [
      ...commonLinks,
      { to: '/government/dashboard', text: 'Dashboard', icon: <FaTachometerAlt className="me-1" /> },
    ...
    <header className={`sticky-top ${scrolled ? 'shadow-sm' : ''}`} 
      ...
      <Navbar 
        ...
        style={{
          ...
          '--bs-navbar-disabled-color': darkMode ? 'rgba(255, 255, 255, 0.5)' : 'rgba(0, 0, 0, 0.5)'
        }}
      >
      <Container fluid="lg">
        <div className="d-flex justify-content-between w-100">
          ...
          <div className="d-flex align-items-center">
            ...
            <Button 
              variant="link" 
              className={`d-lg-none p-0 text-${darkMode ? 'light' : 'dark'} me-3 bg-transparent border-0`}
            ...
            <Form 
              className={`d-none d-lg-flex me-3 ${showSearch ? 'd-flex' : 'd-none'}`} 
            ...
            <Button 
              variant="link" 
              className={`p-0 text-${darkMode ? 'light' : 'dark'} me-3 bg-transparent border-0`}
              onClick={toggleTheme}
            ...
            {isAuthenticated ? (
              <>
                ...
                <div className="position-relative me-3">
                  <Button 
                    variant="link" 
                    className={`p-0 text-${darkMode ? 'light' : 'dark'} position-relative`}
                  ...
                  {showNotifications && (
                    <div className="position-absolute end-0 mt-2 bg-white rounded shadow-lg" style={{ width: '320px', maxHeight: '400px', overflowY: 'auto', zIndex: 1100 }}>
                        ...
                        <div className="list-group list-group-flush">
                          {notifications.map(notification => (
                            ...
                            >
                              ...
                              {!notification.read && (
                                <small className="text-primary">New</small>
                              )}
                            </div>
                          ))}
                        </div>
                ...
                <NavDropdown
                  title={
                    <div className="d-flex align-items-center">
                      <div className="position-relative">
                        <div className={`rounded-circle d-flex align-items-center justify-content-center ${darkMode ? 'bg-secondary' : 'bg-light'}`} 
                             style={{ width: '32px', height: '32px' }}>
                          <FaUser className={darkMode ? 'text-light' : 'text-dark'} />
                        </div>
                      </div>
